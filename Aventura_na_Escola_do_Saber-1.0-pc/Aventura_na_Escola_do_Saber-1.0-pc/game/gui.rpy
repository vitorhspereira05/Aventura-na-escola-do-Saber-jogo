...
## Cor de destaque: Azul Ciano Vibrante (o mesmo da Professora Sofia).
define gui.accent_color = '#20a7b2'

## Cor em repouso: Um cinza médio azulado para não distrair.
define gui.idle_color = '#ffffff'

## Cor para texto pequeno: Versão ligeiramente mais clara do idle.
define gui.idle_small_color = '#78909c'

## Cor de passagem do mouse: Dourado Brilhante (cor do saber/estrelas no logo).
define gui.hover_color = '#ffcc00'

## Cor selecionada: Azul Escuro Profundo (cor do fundo do logo).
define gui.selected_color = '#154c5e'

## Cor insensível: Cinza semitransparente para botões bloqueados.
define gui.insensitive_color = '#5f7d8e7f'

## Cores das barras (Muted): Tons que lembram as fitas e bordas do logo.
define gui.muted_color = '#1b5e70'
define gui.hover_muted_color = '#20a7b2'

## Cores do texto de diálogo: Cinza quase preto para máxima legibilidade.
define gui.text_color = '#2c3e50'
define gui.interface_text_color = '#2c3e50'


## Fontes e tamanhos de fonte ##################################################

## A fonte usada para o texto do jogo.
define gui.text_font = "fonts/Montserrat-Bold.ttf"
